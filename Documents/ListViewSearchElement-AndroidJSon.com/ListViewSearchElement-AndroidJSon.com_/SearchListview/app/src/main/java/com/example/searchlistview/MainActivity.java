...
//            }
    ...
    */
    public class JSONDownloader {
        //SAVE/RETRIEVE URLS
        private static final String JSON_DATA_URL="http://10.3.181.198:3000/product_views?brand=ilike.*wardah&active=eq.true";
        //INSTANCE FIELDS
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            try
                            {
                                for(int i=0;i<response.length();i++)
                                {
                                    ...
                                    String techExists=jo.getString("gt_batam");
